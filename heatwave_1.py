...
def detect(t, temp, climatologyPeriod=[None,None], pctile=90, windowHalfWidth=5, smoothPercentile=False, smoothPercentileWidth=0, minDuration=2, joinAcrossGaps=False, maxGap=0, maxPadLength=False, coldSpells=False, alternateClimatology=False, Ly=False):
    '''
    ...
    exceed_bool = temp - np.percentile(temp, 90)
