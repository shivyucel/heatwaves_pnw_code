...
model_26 <- runMLwiN(c(residential_difference, workplaces_difference, transit_difference, grocery_pharmacy_difference, retail_difference, parks_difference) ~ 1 
                    + heat_temp_centered*state + temp_disff + stage_frac  + weekend 
...
write.csv(x, file='/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/regression/params_clean_final_90_v1.csv')
```
