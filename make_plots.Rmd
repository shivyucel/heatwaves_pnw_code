...
mob_vars <- st_read("/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/mobility_heat/final_multivariate_3_SD_90_v6.csv")
...
#level 2 variables
mob_vars$first_annual_hw <- as.factor(mob_vars$first_annual_hw)
...
clean_nw = st_read('/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/nw_clean_shape/nw_clean_shape_trim.shp')
nw_map <- st_read('/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/results/plots/state_maps/state_maps_clean.shp')
location_temps <- st_read('/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/results/plots/state_maps/location_temps.shp')
```
...
p1 <- ggplot(filter(year_describe, variable == c('residential_difference')), aes(x=value)) + 
    geom_histogram() + 
    scale_fill_lancet() + 
  labs(y = "Count", x="", color="Province/State") +
...
p2 <- ggplot(filter(year_describe, variable == c('workplaces_difference')), aes(x=value)) + 
    geom_histogram() +
    scale_fill_lancet() + 
  labs(y = "", x="Heat-control % change", color="Province/State") +
...
#ggsave("/Users/shivyucel/Documents/projects/DPhil/Code_Data/data/results/plots/variable_dist_v6.pdf")
```
