...
p11 <- ggplot(filter(regression, variable == c('over_65')), aes(x=coef, y=response, alpha=p, color=c)) + 
  geom_point(size=1) + 
  labs(x="coefficient", y = "", alpha="Significance: ") + 
...
ggarrange(p8, p9, p10, p11, hjust=-7, common.legend = TRUE, labels = c("A", "B", "C", "D"))
